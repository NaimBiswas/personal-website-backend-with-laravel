...
<section id="home"
    ...
    style="background: url('{{ asset('asset/fontend') }}/uploads/banner-01.jpg')">
    <div class="heading">
        ...
        <h3 class="cd-headline clip is-full-width">
            ...
            <div class="btn-ber">
                <a class="get_btn hvr-bounce-to-top"
                    href="#">Get started</a>
                <a class="learn_btn hvr-bounce-to-top"
                    href="#">Learn More</a>
            </div>
        </h3>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="message-box">
                    ...
                    <p>Sed vitae rutrum neque. Ut id erat sit amet libero bibendum aliquam. Donec ac egestas
                        libero, eu bibendum risus. Phasellus et congue justo.</p>

                    <a href="#"
                        class="sim-btn hvr-bounce-to-top"><span>Contact Us</span></a>
                </div><!-- end messagebox -->
            </div><!-- end col -->

            <div class="col-md-6">
                <div class="right-box-pro wow fadeIn">
                    <img src="{{ asset('asset/fontend') }}/uploads/about_04.jpg"
                        alt=""
        ...
        <div class="gallery-list row">
            <div class="col-md-4 col-sm-6 gallery-grid gal_a gal_b">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-01.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-01.jpg"
            ...
            <div class="col-md-4 col-sm-6 gallery-grid gal_c gal_b">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-02.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-02.jpg"
                            data-rel="prettyPhoto[gal]"
                            class="hoverbutton global-radius"><i class="fa fa-picture-o"></i></a>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 gallery-grid gal_a gal_c">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-03.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-03.jpg"
                            data-rel="prettyPhoto[gal]"
                            class="hoverbutton global-radius"><i class="fa fa-picture-o"></i></a>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 gallery-grid gal_b gal_a">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-04.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-04.jpg"
                            data-rel="prettyPhoto[gal]"
                            class="hoverbutton global-radius"><i class="fa fa-picture-o"></i></a>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 gallery-grid gal_a gal_c">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-05.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-05.jpg"
                            data-rel="prettyPhoto[gal]"
                            class="hoverbutton global-radius"><i class="fa fa-picture-o"></i></a>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 gallery-grid gal_c gal_a">
                <div class="gallery-single fix">
                    <img src="{{ asset('asset/fontend') }}/uploads/gallery_img-06.jpg"
                        class="img-fluid"
                        alt="Image">
                    <div class="img-overlay">
                        <a href="uploads/gallery_img-06.jpg"
                            data-rel="prettyPhoto[gal]"
                            class="hoverbutton global-radius"><i class="fa fa-picture-o"></i></a>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-lg-4">
                <div class="post-box">
                    <div class="post-thumb">
                        <img src="{{ asset('asset/fontend') }}/uploads/blog-01.jpg"
                            class="img-fluid"
                            alt="post-img" />
                        <div class="date">
                            <span>06</span>
                    ...
                    <div class="post-info">
                        ...
                        <p>Etiam materials ut mollis tellus, vel posuere nulla. Etiam sit amet massa sodales
            ...
            <div class="col-md-4 col-sm-6 col-lg-4">
                <div class="post-box">
                    <div class="post-thumb">
                        <img src="{{ asset('asset/fontend') }}/uploads/blog-02.jpg"
                            class="img-fluid"
                            alt="post-img" />
                        <div class="date">
                            <span>06</span>
            ...
            <div class="col-md-4 col-sm-6 col-lg-4">
                <div class="post-box">
                    <div class="post-thumb">
                        <img src="{{ asset('asset/fontend') }}/uploads/blog-03.jpg"
                            class="img-fluid"
                            alt="post-img" />
                        <div class="date">
                            <span>06</span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="our-team">
                    <div class="pic">
                        <img src="{{ asset('asset/fontend') }}/uploads/img-2.jpg">
                    </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="our-team">
                    <div class="pic">
                        <img src="{{ asset('asset/fontend') }}/uploads/img-4.jpg">
                    </div>
                    <div class="team-content">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="our-team">
                    <div class="pic">
                        <img src="{{ asset('asset/fontend') }}/uploads/img-1.jpg">
                    </div>
                    <div class="team-content">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="our-team">
                    <div class="pic">
                        <img src="{{ asset('asset/fontend') }}/uploads/img-3.jpg">
                    </div>
                    <div class="team-content">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable">
                    ...
                    <div class="pricing-content">
                        ...
                        <a href="#"
                            class="sim-btn hvr-bounce-to-top pricingTable-signup">Buy Now</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <button id="sendMessageButton"
                                    class="sim-btn hvr-bounce-to-top"
